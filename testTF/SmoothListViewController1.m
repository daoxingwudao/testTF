...
#import "SmoothListViewController1.h"
#import "MJRefresh.h"

@interface SmoothListViewController1() <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, assign) NSInteger count;
@end

@implementation SmoothListViewController1
